...
const fetchCompatibleFilteredCpuCoolers = async (id, query) => {
  return await Axios.get(`${process.env.REACT_APP_BASE_API}/compatible/cpucooler/filter/${id}/${query.replace(/[/^#\%]/g,"")}`);
};
...
export {
  ...
  fetchCompatibleFilteredCpuCoolers,
  createCpuCooler,
  fetchCpuCoolerById,
